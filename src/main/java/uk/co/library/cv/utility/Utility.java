package uk.co.library.cv.utility;
...
import uk.co.library.cv.browserfactory.ManageBrowser;
...
//***************************** Is Display Methods **********************************************//
    ...
    public static void takeScreenShot() {
        String filePath = System.getProperty("user.dir") + "/src/main/java/uk/co/library/cv/screenshots/";
    ...
    public static String getScreenshot(WebDriver driver, String screenshotName) {
        ...
        String destination = System.getProperty("user.dir") + "/src/main/java/uk/co/library/cv/screenshots/" + screenshotName + dateName + ".png";
